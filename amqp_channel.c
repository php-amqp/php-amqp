...
static PHP_METHOD(amqp_channel_class, __construct)
{
    ...
    zend_update_property_long(
        this_ce,
        PHP_AMQP_COMPAT_OBJ_P(getThis()),
        ZEND_STRL("global_prefetch_count"),
...
static PHP_METHOD(amqp_channel_class, setPrefetchCount)
{
    ...
    if (!php_amqp_is_valid_prefetch_count(prefetch_count)) {
        zend_throw_exception_ex(
            ...
            0 TSRMLS_CC,
            "Parameter 'prefetch_count' must be between 0 and %u.",
...
static PHP_METHOD(amqp_channel_class, setPrefetchSize)
{
    ...
    if (!php_amqp_is_valid_prefetch_size(prefetch_size)) {
        zend_throw_exception_ex(
            amqp_connection_exception_class_entry,
            0 TSRMLS_CC,
            "Parameter 'prefetch_size' must be between 0 and %u.",
...
static PHP_METHOD(amqp_channel_class, setGlobalPrefetchCount)
{
    ...
    if (!php_amqp_is_valid_prefetch_count(global_prefetch_count)) {
        zend_throw_exception_ex(
            amqp_connection_exception_class_entry,
            0 TSRMLS_CC,
            "Parameter 'global_prefetch_count' must be between 0 and %u.",
            PHP_AMQP_MAX_PREFETCH_COUNT
        );
        return;
    }
...
static PHP_METHOD(amqp_channel_class, setGlobalPrefetchSize)
{
    ...
    if (!php_amqp_is_valid_prefetch_size(global_prefetch_size)) {
        zend_throw_exception_ex(
            amqp_connection_exception_class_entry,
            0 TSRMLS_CC,
            "Parameter 'global_prefetch_size' must be between 0 and %u.",
            PHP_AMQP_MAX_PREFETCH_SIZE
        );
        return;
    }
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_amqp_channel_class_setGlobalPrefetchSize, ZEND_SEND_BY_VAL, 1, IS_VOID, 0)
    ZEND_ARG_TYPE_INFO(0, size, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_amqp_channel_class_getGlobalPrefetchSize, ZEND_SEND_BY_VAL, 0, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_amqp_channel_class_setGlobalPrefetchCount, ZEND_SEND_BY_VAL, 1, IS_VOID, 0)
    ZEND_ARG_TYPE_INFO(0, count, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_amqp_channel_class_getGlobalPrefetchCount, ZEND_SEND_BY_VAL, 0, IS_LONG, 0)
ZEND_END_ARG_INFO()
